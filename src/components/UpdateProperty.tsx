...
export default function UpdateProperty({ setproperty_id, setbrand, sethome_name, setcity_name, setneighborhood,settimezone,setunit_count,setrownum, setcreatePropTrig,setcreateSpaceTrig }) {
  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        <Button variant="outlined" onClick={handleClickP} endIcon={<SearchIcon />} >
          {/*type="submit"*/}
          Update Property
        </Button>
      </div>
