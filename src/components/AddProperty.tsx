...
export default function AddProperty({ setproperty_id, setbrand, sethome_name, setcity_name, setneighborhood,settimezone,setunit_count,setrownum, setcreatePropTrig }) {
